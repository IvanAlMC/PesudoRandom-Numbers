...
public class ButtonsPanel extends JPanel{
	...
	private void initComponents( ActionListener listener) {
		...
		btnOne.setActionCommand(Constants.GET_MESSAGE_GENERATE_LEASTE_SQUARES);
		...
		btnTwo.setActionCommand(Constants.GET_MESSAGE_GENERATE_LINEAR_CONGRUENCE);
		...
		btnThree.setActionCommand(Constants.GET_MESSAGE_GENERATE_MULTIPLICATE_CONGRUENCE);
		...
		btnGenerateGraph.setActionCommand(Constants.GET_ADD_GENERATE);
